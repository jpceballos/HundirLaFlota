...
public class Tablero extends JPanel{
    ...
    Boton[] boton = new Boton [225];
    JLabel[] letra = new JLabel[16];
    JLabel[] numero = new JLabel[15];
	...
	GridLayout layout = new GridLayout(17,16);
	setLayout(layout);
	...
	for(int x=0;x<225;x++){
            ...
            if(objeto==boton[x] && !boton[x].getActivo()){
                ...
                if(numero<=15-n_barcos){
                    
                    for(int y=0;y<=15-n_barcos;y++){
                ...
                for(int y=n_barcos-1;y<15;y++){
                    ...
                    if(objeto==boton[x] && linea==y){
                        ...
                        for(int w = 0;w<n_barcos;w++){
                            ...
                            }else if(contador/15==n_barcos-1){
                                    if(!boton[x-contador].getActivo()){
					boton[x-contador].setColorEleccionVerde();
					boton[x-contador].setIluminado(true);
	...
	// Creacion de metodos	
		...
		if(objeto==boton[x] && !boton[x].getActivo()){
                    ...
                    }else if(numero>15-n_barcos){
                                es_posible_colocar = false;
                            
                                for(int y=16-n_barcos;y<15;y++){
						
                                    if(objeto==boton[x] && numero==y){
							
					for(int w = 0;w<15-y;w++){
